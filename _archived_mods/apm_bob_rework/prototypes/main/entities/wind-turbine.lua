...
local wind_turbine_persistent_sound = {
  variations = {
    {
      filename = soundPath .. "wind-turbine-rotating.ogg",
      volume = 0.55,
    },
    {
      filename = soundPath .. "wind-turbine-rotating-2.ogg",
      volume = 0.38,
    },
  },
  aggregation = {
...
data:extend({
  {
    ...
    icon = iconPath .. "wind-turbine.png",
    icon_size = 64,
    icon_mipmaps = 4,
    ...
    water_reflection = {
      pictures = {
        filename = entityPath .. "wind-turbine/wind-turbine-reflection.png",
        priority = "extra-high",
        width = 20,
        height = 25,
    ...
    animation = {
      layers = {
        {
          filename = entityPath .. "wind-turbine/wind-turbine.png",
          priority = "high",
          width = 98,
          height = 143,
          frame_count = 30,
          ...
          shift = { 0, -1.2 },
          hr_version = {
            filename = entityPath .. "wind-turbine/hr-wind-turbine.png",
            priority = "medium",
            width = 196,
            height = 286,
            scale = 0.5,
        ...
        {
          filename = entityPath .. "wind-turbine/wind-turbine-shadow.png",
          priority = "high",
          width = 121,
          height = 50,
          frame_count = 30,
          ...
          shift = { 1.15, 0.05 },
          hr_version = {
            filename = entityPath .. "wind-turbine/hr-wind-turbine-shadow.png",
            priority = "medium",
            width = 242,
            height = 100,
            scale = 0.65,
