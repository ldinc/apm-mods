...
--
-- ----------------------------------------------------------------------------
apm.energy_addon.icons.path.depleted_battery_overlay =
'__apm_resource_pack_ldinc__/graphics/icons/dynamics/apm_depleted_battery_overlay.png'
apm.energy_addon.icons.path.rtg_decayed = '__apm_resource_pack_ldinc__/graphics/icons/apm_rtg_decayed.png'
apm.energy_addon.icons.path.electric_symbol =
'__apm_resource_pack_ldinc__/graphics/icons/dynamics/apm_electric_symbol.png'

-- Icons ----------------------------------------------------------------------
--
--
-- ----------------------------------------------------------------------------
apm.energy_addon.icons.depleted_battery_overlay = { size = 64, icon = apm.energy_addon.icons.path
.depleted_battery_overlay, filename = apm.energy_addon.icons.path.depleted_battery_overlay, icon_mipmaps = 4, icon_size = 64 }
