data:extend({
        ...
        {
            type = "int-setting",
            name = "rampantFixed--enemySeed",
            description = "rampantFixed--enemySeed",
            setting_type = "startup",
            minimum_value = 1,
        ...
        {
            type = "bool-setting",
            name = "rampantFixed--showDisableNewEnemiesButton",
            description = "rampantFixed--showDisableNewEnemiesButton",
