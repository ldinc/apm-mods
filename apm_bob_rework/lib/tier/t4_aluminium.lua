...
local aluminiumTier = {
    ...
    extraConstructionAlloy = apm.bob_rework.lib.entities.cobaltSteel,
    heatAlloy = apm.bob_rework.lib.entities.tungsten,
    logic = apm.bob_rework.lib.entities.logicProcessing,
    pipe = apm.bob_rework.lib.entities.tungstenPipe,
    heatPipe = apm.bob_rework.lib.entities.tungstenPipe,
    exchangePipe = apm.bob_rework.lib.entities.tungstenPipe,
    basement = apm.bob_rework.lib.entities.refinedConcrete,
    basementK = 1,
    engineUnit = apm.bob_rework.lib.entities.electricEngineUnit,
    gearWheel = apm.bob_rework.lib.entities.cobaltGearWheel,
    bearing = apm.bob_rework.lib.entities.cobaltBearing,
