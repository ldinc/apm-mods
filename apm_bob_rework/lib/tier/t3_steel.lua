...
-- if settings.startup['apm_bob_rework_plastic'].value == true then
--     steelTier.constructionAlloy = apm.bob_rework.lib.entities.plastic
--     steelTier.pipe = apm.bob_rework.lib.entities.plasticPipe
-- end

apm.bob_rework.lib.tier.steel = steelTier
apm.bob_rework.lib.tier.list[3] = steelTier

-- apm.bob_rework.lib.tier.steel2 = steelTier2