require('lib.entities.apm')
require('lib.entities.bobPlates')
require('lib.entities.basements')
require('lib.entities.logic')
require('lib.entities.pipes')
-- require('lib.entities.platesAndAlloys')
require('lib.entities.fluids')
require('lib.entities.belts')
require('lib.entities.gearingAndBearings')
require('lib.entities.inserters')
require('lib.entities.wires')
require('lib.entities.pumps')
require('lib.entities.nuclear')
require('lib.entities.science')
...
apm.bob_rework.lib.entities.electricMiner_t2 = 'electric-mining-drill'
apm.bob_rework.lib.entities.advancedElectricMiner_t2 = 'bob-mining-drill-1'
apm.bob_rework.lib.entities.electricMiner_t3 = 'bob-mining-drill-2'
