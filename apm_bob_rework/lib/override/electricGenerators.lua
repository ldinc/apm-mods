...
apm.bob_rework.lib.override.electricGenerators = function ()
    ...
    buildSteamGenerator('steam-engine-3', apm.bob_rework.lib.tier.steel2, 5)
    ...
    buildFluidGenerator('fluid-generator-2', apm.bob_rework.lib.tier.steel2, 7)
    ...
    buildBoiler('boiler-3', apm.bob_rework.lib.tier.steel2)
    ...
    buildFluidBoiler('oil-boiler-2', 'boiler-3', apm.bob_rework.lib.tier.steel2)
