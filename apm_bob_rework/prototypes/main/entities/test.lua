...
local ppPath = "__apm_bob_rework_ldinc__/test/"
...
sinkhole.animation.layers[1].filename = ppPath.."base.png"
sinkhole.animation.layers[1].priority = "high"
sinkhole.animation.layers[1].width = 576
sinkhole.animation.layers[1].height = 512
sinkhole.animation.layers[1].frame_count = 1
sinkhole.animation.layers[1].line_length = 1
sinkhole.animation.layers[1].hr_version = {}
sinkhole.animation.layers[1].hr_version.shift = { 0.71875, -0.1875 }
sinkhole.animation.layers[1].hr_version.filename = ppPath.."base.png"
sinkhole.animation.layers[1].hr_version.priority = "high"
sinkhole.animation.layers[1].hr_version.width = 576
sinkhole.animation.layers[1].hr_version.height = 512
sinkhole.animation.layers[1].hr_version.frame_count = 1
sinkhole.animation.layers[1].hr_version.line_length = 1
sinkhole.animation.layers[1].hr_version.shift = { 0.71875, -0.1875 }
sinkhole.animation.layers[1].hr_version.scale = 0.2

sinkhole.animation.layers[2] = {}
sinkhole.animation.layers[2].filename = ppPath.."shadow.png"
sinkhole.animation.layers[2].priority = "high"
sinkhole.animation.layers[2].draw_as_shadow = true
sinkhole.animation.layers[2].width = 576
sinkhole.animation.layers[2].height = 512
sinkhole.animation.layers[2].frame_count = 1
sinkhole.animation.layers[2].line_length = 1
sinkhole.animation.layers[2].shift = { 0.71875, -0.1875 }
sinkhole.animation.layers[2].hr_version = {}
sinkhole.animation.layers[2].hr_version.filename = ppPath.."shadow.png"
sinkhole.animation.layers[2].hr_version.priority = "high"
sinkhole.animation.layers[2].hr_version.draw_as_shadow = true
sinkhole.animation.layers[2].hr_version.width = 576
sinkhole.animation.layers[2].hr_version.height = 512
sinkhole.animation.layers[2].hr_version.frame_count = 1
sinkhole.animation.layers[2].hr_version.line_length = 1
sinkhole.animation.layers[2].hr_version.shift = { 0.71875, -0.1875 }
sinkhole.animation.layers[2].hr_version.scale = 0.2
