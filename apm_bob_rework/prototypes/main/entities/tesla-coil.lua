...
local tesla_coil_sound = {
  filename = soundPath.."tesla-coil.ogg",
  volume = 0.5,
  aggregation = {
    max_count = 2,
    remove = false,
...
local tesla_coil_electric_beam_sound = {
  variations = {
    {
      filename = soundPath .. "zap-1.ogg",
      volume = 0.25,
    },
    {
      filename = soundPath .. "zap-2.ogg",
      volume = 0.25,
    },
    {
      filename = soundPath .. "zap-3.ogg",
      volume = 0.25,
    },
  },
...
data:extend({
  -- Tesla coil tower
  {
    ...
    animation = {
      layers = {
        {
          filename = entityPath .. "tesla-coil/tesla-coil-animation-light.png",
          priority = "high",
          width = 97,
          height = 116,
          frame_count = 60,
          ...
          hr_version = {
            filename = entityPath .. "tesla-coil/hr-tesla-coil-animation-light.png",
            priority = "high",
            width = 194,
            height = 232,
            scale = 0.5,
        ...
        {
          filename = entityPath .. "tesla-coil/tesla-coil-animation.png",
          priority = "high",
          width = 97,
          height = 116,
          frame_count = 60,
          ...
          run_mode = "forward",
          hr_version = {
            filename = entityPath .. "tesla-coil/hr-tesla-coil-animation.png",
            priority = "high",
            width = 194,
            height = 232,
            scale = 0.5,
        ...
        {
          filename = entityPath .. "tesla-coil/tesla-coil-shadow.png",
          priority = "medium",
          width = 125,
          height = 75,
          repeat_count = 60,
          ...
          draw_as_shadow = true,
          hr_version = {
            filename = entityPath .. "tesla-coil/hr-tesla-coil-shadow.png",
            priority = "medium",
            width = 250,
            height = 150,
            scale = 0.5,
