...
sieve.animation.layers[1].filename = "__apm_bob_rework_ldinc__/graphics/entities/burner-sieve/lr-burner-sieve.png"
...
sieve.animation.layers[1].hr_version.filename = "__apm_bob_rework_ldinc__/graphics/entities/burner-sieve/hr-burner-sieve.png"
...
sieve.animation.layers[2].filename = "__apm_bob_rework_ldinc__/graphics/entities/burner-sieve/lr-burner-sieve-shadow.png"
...
sieve.animation.layers[2].hr_version.filename = "__apm_bob_rework_ldinc__/graphics/entities/burner-sieve/hr-burner-sieve-shadow.png"
