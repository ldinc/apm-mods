...
apm.lib.utils.recipe.allow_productivity("apm_steel_2")
...
apm.lib.utils.recipe.allow_productivity("apm_egen_unit")
apm.lib.utils.recipe.allow_productivity("apm_gun_powder")
...
--- Section for final overwrites for some mods compat
