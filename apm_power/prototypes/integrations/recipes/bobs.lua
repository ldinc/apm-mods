...
if mods.boblogistics then
	...
	if apm.lib.utils.setting.get.startup("bobmods-logistics-beltoverhaul") then
		apm.lib.utils.recipe.ingredient.replace("logistic-science-pack", "bob-basic-transport-belt", "transport-belt")
	end
...
if mods.bobplates then
	apm.lib.utils.recipe.ingredient.mod("bob-enriched-fuel", "solid-fuel", 1)
