...
local puddling_furnace = {
	...
	minable = { mining_time = 0.2, result = "apm_puddling_furnace_0" },
	crafting_categories = { "apm_puddling_furnace" },
	crafting_speed = 1,
	fast_replaceable_group = "apm_steelworks",
	next_upgrade = "apm_steelworks_0",
	max_health = 250,
	corpse = "big-remnants",
	...
	energy_usage = apm.power.constants.energy_usage.puddling_furnace_0,
...
local steelworks = {
	...
	flags = { "placeable-neutral", "placeable-player", "player-creation" },
	minable = { mining_time = 0.2, result = "apm_steelworks_0" },
	crafting_categories = { "apm_steelworks" },
	crafting_speed = 2,
	fast_replaceable_group = "apm_steelworks",
	next_upgrade = "apm_steelworks_1",
	max_health = 250,
	corpse = "big-remnants",
	dying_explosion = "medium-explosion",
	resistances = { { type = "fire", percent = 90 } },
	...
	energy_usage = apm.power.constants.energy_usage.steelworks_0,
