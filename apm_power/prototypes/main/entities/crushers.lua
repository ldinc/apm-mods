...
local crusher = {
	...
	minable = { mining_time = 0.1, result = "apm_crusher_machine_0" },
	crafting_categories = { "apm_crusher" },
	crafting_speed = 0.5,
	fast_replaceable_group = "apm_power_crusher_machine",
	next_upgrade = "apm_crusher_machine_1",
	max_health = 250,
	corpse = "big-remnants",
	...
	-- working_sound.apparent_volume = 1.5
