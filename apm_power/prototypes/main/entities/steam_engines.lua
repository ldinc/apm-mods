...
steam_engine.horizontal_animation.layers[3].filename =
'__apm_resource_pack_ldinc__/graphics/masks/steam_engine/hr-steam-engine-H.png'
...
steam_engine.vertical_animation.layers[3].filename =
'__apm_resource_pack_ldinc__/graphics/masks/steam_engine/hr-steam-engine-V.png'
