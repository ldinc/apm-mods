...
data:extend(
{
    ...
    },
    {
        ...
        icons = apm.lib.utils.icon.generate.fluid({r=0.197, g=0.145, b=0.114}, {r=0.227, g=0.185, b=0.154}, nil),
        icon_size = 32,
        group = "apm_power",
        subgroup = "apm_power_fluid",
        order = 'ad_c'
    },
    {
        ...
        icons = apm.lib.utils.icon.generate.chemical({r=1, g=1, b=1}, nil, {r=0.2, g=0.2, b=0.2}, {r=1, g=1, b=1}, apm.power.icons.coke_oven_gas_symbol),
        icon_size = 32,
        fuel_value = '0.5MJ',
        group = "apm_power",
        subgroup = "apm_power_fluid",
