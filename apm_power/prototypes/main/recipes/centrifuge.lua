...
recipe.categories = { "apm_centrifuge_0" }
...
recipe.results = {
	{ type = "item",  name = "apm_wet_mud", amount_min = 1, amount_max = 1, independent_probability = 0.5 },
	{ type = "fluid", name = "water",       amount = 195 },
	{ type = "item",  name = "raw-fish",    amount_min = 1, amount_max = 1, independent_probability = 0.0001, show_details_in_recipe_tooltip = false }
}
recipe.main_product = ""
