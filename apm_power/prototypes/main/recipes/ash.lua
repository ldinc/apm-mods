...
recipe.categories = { "apm_centrifuge_1" }
recipe.subgroup = "apm_power_ash"
recipe.order = "bd_a"
recipe.icons = icons
...
recipe.results = {
	{ type = "item",  name = "uranium-ore",                   amount_min = 1, amount_max = 1, independent_probability = 0.02, show_details_in_recipe_tooltip = false },
