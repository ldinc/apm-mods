...
local self = 'apm_power/prototypes/main/recipes/entities/crushers.lua'
...
local recipe = {}
recipe.type = "recipe"
recipe.name = "apm_crusher_machine_0"
...
recipe.main_product = 'apm_crusher_machine_0'
...
local recipe = {}
recipe.type = "recipe"
recipe.name = "apm_crusher_machine_1"
...
recipe.main_product = 'apm_crusher_machine_1'
recipe.requester_paste_multiplier = 4
recipe.always_show_products = true
recipe.always_show_made_in = apm_power_always_show_made_in

if apm.lib.features.reuse_previous_tier then
	apm.lib.utils.recipe.ingredient.mod_by_ref(recipe, 'apm_crusher_machine_0', 1)
end
...
local recipe = {}
recipe.type = "recipe"
recipe.name = "apm_crusher_machine_2"
...
recipe.main_product = 'apm_crusher_machine_2'
recipe.requester_paste_multiplier = 4
recipe.always_show_products = true
recipe.always_show_made_in = apm_power_always_show_made_in

if apm.lib.features.reuse_previous_tier then
	apm.lib.utils.recipe.ingredient.mod_by_ref(recipe, 'apm_crusher_machine_1', 1)
end
