...
local self = 'apm_power/prototypes/main/recipes/entities/presses.lua'
...
local recipe = {}
recipe.type = "recipe"
recipe.name = "apm_press_machine_0"
recipe.normal = {}
...
recipe.normal.main_product = 'apm_press_machine_0'
...
local recipe = {}
recipe.type = "recipe"
recipe.name = "apm_press_machine_1"
recipe.normal = {}
recipe.normal.enabled = false
...
if reusable then
    table.insert(recipe.normal.ingredients, 'apm_press_machine_0')
    table.insert(recipe.expensive.ingredients, 'apm_press_machine_0')
end
...
local recipe = {}
recipe.type = "recipe"
recipe.name = "apm_press_machine_2"
recipe.normal = {}
recipe.normal.enabled = false
...
if reusable then
    table.insert(recipe.normal.ingredients, 'apm_press_machine_1')
    table.insert(recipe.expensive.ingredients, 'apm_press_machine_1')
end
