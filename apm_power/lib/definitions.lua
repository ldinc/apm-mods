...
apm.power.constants.emissions.t3                                  = { pollution = 2.5 }
apm.power.constants.emissions.gh_0                                = { pollution = 2.5 }
apm.power.constants.emissions.gh_1                                = { pollution = -5 }
apm.power.constants.emissions.gh_2                                = { pollution = -5 }
apm.power.constants.emissions.lab_0                               = { pollution = 10 }
apm.power.constants.emissions.lab_1                               = { pollution = 5 }
apm.power.constants.emissions.cp_0                                = { pollution = 8 }
apm.power.constants.emissions.cp_1                                = { pollution = 6 }
apm.power.constants.emissions.cp_2                                = { pollution = 4 }
apm.power.constants.emissions.cp_3                                = { pollution = 3 }
apm.power.constants.emissions.air_cleaner_0                       = { pollution = -50 }
apm.power.constants.emissions.air_cleaner_1                       = { pollution = -150 }
apm.power.constants.emissions.offpump_0                           = { pollution = 3 }
apm.power.constants.emissions.offpump_1                           = { pollution = 2 }
apm.power.constants.emissions.steam_miner                         = { pollution = 4.5 }
...
apm.power.icons.path.resin                               = '__apm_resource_pack_ldinc__/graphics/icons/apm_resin.png'
apm.power.icons.path.rubber                              = '__apm_resource_pack_ldinc__/graphics/icons/apm_rubber.png'
apm.power.icons.path.gearing                             = '__apm_resource_pack_ldinc__/graphics/icons/apm_gearing.png'
apm.power.icons.path.wood_board                          = '__apm_resource_pack_ldinc__/graphics/icons/apm_wood_board.png'
apm.power.icons.path.mechanical_relay                    = '__apm_resource_pack_ldinc__/graphics/icons/apm_mechanical_relay.png'
apm.power.icons.path.steam_relay                         = '__apm_resource_pack_ldinc__/graphics/icons/apm_steam_relay.png'
apm.power.icons.path.sealing_rings                       = '__apm_resource_pack_ldinc__/graphics/icons/apm_sealing_rings.png'
apm.power.icons.path.treated_wood_planks                 = '__apm_resource_pack_ldinc__/graphics/icons/apm_treated_wood_planks.png'
apm.power.icons.path.electromagnet                       = '__apm_resource_pack_ldinc__/graphics/icons/apm_electromagnet.png'
apm.power.icons.path.sciencepack_1                       = "__apm_resource_pack_ldinc__/graphics/icons/apm_industrial_science_pack.png"
apm.power.icons.path.sciencepack_2                       = "__apm_resource_pack_ldinc__/graphics/icons/apm_steam_science_pack.png"
apm.power.icons.path.filter_charcoal                     = '__apm_resource_pack_ldinc__/graphics/icons/apm_filter_charcoal.png'
apm.power.icons.path.filter_charcoal_used                = '__apm_resource_pack_ldinc__/graphics/icons/apm_filter_charcoal_used.png'
apm.power.icons.path.crucible_raw                        = '__apm_resource_pack_ldinc__/graphics/icons/apm_stone_crucibel_raw.png'
apm.power.icons.path.crucible                            = '__apm_resource_pack_ldinc__/graphics/icons/apm_stone_crucibel.png'
apm.power.icons.path.tree_seeds                          = '__apm_resource_pack_ldinc__/graphics/icons/apm_tree_seeds.png'
apm.power.icons.path.fertiliser_1                        = '__apm_resource_pack_ldinc__/graphics/icons/apm_fertiliser_1.png'
apm.power.icons.path.fertiliser_2                        = '__apm_resource_pack_ldinc__/graphics/icons/apm_fertiliser_2.png'
apm.power.icons.path.sieve                               = '__apm_resource_pack_ldinc__/graphics/icons/dynamics/sieve.png'
apm.power.icons.path.sieve_handel                        = '__apm_resource_pack_ldinc__/graphics/icons/dynamics/sieve_handel.png'
apm.power.icons.path.crusher_drums                       = '__apm_resource_pack_ldinc__/graphics/icons/apm_crusher_drumms.png'
apm.power.icons.path.crusher_drums_used                  = '__apm_resource_pack_ldinc__/graphics/icons/apm_crusher_drumms_used.png'
apm.power.icons.path.press_plates                        = '__apm_resource_pack_ldinc__/graphics/icons/apm_press_plates.png'
apm.power.icons.path.press_plates_used                   = '__apm_resource_pack_ldinc__/graphics/icons/apm_press_plates_used.png'
apm.power.icons.path.saw_blade_iron                      = '__apm_resource_pack_ldinc__/graphics/icons/apm_saw_blade_iron.png'
apm.power.icons.path.saw_blade_iron_used                 = '__apm_resource_pack_ldinc__/graphics/icons/apm_saw_blade_iron_used.png'
...
apm.power.icons.path.crushed_stone_2                     = "__apm_resource_pack_ldinc__/graphics/icons/mip/apm_crushed_stone_2.png"
apm.power.icons.path.crushed_stone_3                     = "__apm_resource_pack_ldinc__/graphics/icons/mip/apm_crushed_stone_3.png"
...
apm.power.icons.path.steam_engine_unit                   = '__apm_resource_pack_ldinc__/graphics/icons/apm_steam_engine.png'
apm.power.icons.path.machine_frame_basic                 = '__apm_resource_pack_ldinc__/graphics/icons/apm_machine_frame_basic.png'
apm.power.icons.path.machine_frame_steam                 = '__apm_resource_pack_ldinc__/graphics/icons/apm_machine_frame_steam.png'
apm.power.icons.path.machine_frame_advanced              = '__apm_resource_pack_ldinc__/graphics/icons/apm_machine_frame_advanced.png'
apm.power.icons.path.machine_frame_basic_used            =
'__apm_resource_pack_ldinc__/graphics/icons/apm_machine_frame_basic_used.png'
apm.power.icons.path.machine_frame_steam_used            =
'__apm_resource_pack_ldinc__/graphics/icons/apm_machine_frame_steam_used.png'
apm.power.icons.path.machine_frame_advanced_used         =
'__apm_resource_pack_ldinc__/graphics/icons/apm_machine_frame_advanced_used.png'
apm.power.icons.path.equipment_battery_tiny              = '__apm_resource_pack_ldinc__/graphics/icons/apm_equipment_battery_tiny.png'

apm.power.icons.path.item_burner_generator_basic         =
'__apm_resource_pack_ldinc__/graphics/icons/apm_equipment_burner_generator_basic.png'
apm.power.icons.path.item_burner_generator_advanced      =
'__apm_resource_pack_ldinc__/graphics/icons/apm_equipment_burner_generator_advanced.png'
apm.power.icons.path.item_equipment_energy_transmitter   =
'__apm_resource_pack_ldinc__/graphics/icons/apm_equipment_energy_transmitter.png'

apm.power.icons.path.equipment_burner_generator_basic    =
'__apm_resource_pack_ldinc__/graphics/equipment/apm_equipment_burner_generator_basic.png'
apm.power.icons.path.equipment_burner_generator_advanced =
'__apm_resource_pack_ldinc__/graphics/equipment/apm_equipment_burner_generator_advanced.png'
apm.power.icons.path.equipment_energy_transmitter        =
'__apm_resource_pack_ldinc__/graphics/equipment/apm_equipment_energy_transmitter.png'
