...
local function CreateHexafluoride(i)
	...
	fluid = {
		...
		localised_name = { "fluid-name.apm_nuclear_hexafluoride", tostring(enrichment / 10) },
		icons = apm.nuclear.icons.get_apm_hexafluoride_enrichment(enrichment),
		icon_size = 32,
		base_color = base_color,
		flow_color = flow_color,
		default_temperature = 57.5,
...
CreateNitricAcidFuelSolution("uranium", { r = 0.004, g = 0.444, b = 0.004 }, { r = 0.018, g = 0.486, b = 0.018 },
	"apm_nuclear_recycling_stage_a", "aa_a")
CreateNitricAcidFuelSolution("mox", { r = 0.861, g = 0.756, b = 0.051 }, { r = 0.961, g = 0.856, b = 0.051 },
	"apm_nuclear_recycling_stage_a", "ab_a")
CreateNitricAcidFuelSolution("thorium", { r = 0.549, g = 0.318, b = 0.133 }, { r = 0.648, g = 0.384, b = 0.175 },
	"apm_nuclear_recycling_stage_a", "ad_a")
CreateNitricAcidFuelSolution("neptunium", { r = 0.861, g = 0.247, b = 0.051 }, { r = 0.961, g = 0.327, b = 0.051 },
	"apm_nuclear_recycling_stage_a", "ae_a")
CreateNitricAcidFuelSolution("breeder_uranium", { r = 0.155, g = 0.693, b = 0.762 }, { r = 0.4, g = 0.863, b = 0.973 },
	"apm_nuclear_recycling_stage_a", "ba_a")
CreateNitricAcidFuelSolution("thorium_breeder", { r = 0.632, g = 0.480, b = 0.098 }, { r = 0.725, g = 0.499, b = 0.126 },
	"apm_nuclear_recycling_stage_a", "bb_a")
...
data:extend(
	{
		...
		---@type data.FluidPrototype
		{
			...
			icons = apm.lib.utils.icon.generate.chemical({ r = 0.615, g = 0.765, b = 0.027 }, nil,
		...
		---@type data.FluidPrototype
		{
			...
			icons = apm.lib.utils.icon.generate.chemical({ r = 0.9, g = 0.9, b = 0.9 }, { r = 0.2, g = 0.2, b = 0.2 },
