...
breeder_reactor.energy_source.fuel_category = "apm_nuclear_breeder"
...
breeder_reactor.heat_buffer.specific_heat = "10MJ"
breeder_reactor.heat_buffer.max_transfer = "10GW"
