...
recipe.normal.main_product = 'apm_fuel_rod_mox'
...
local recipe = {}
recipe.type = "recipe"
recipe.name = "apm_fuel_rod_mox_cooling"
...
recipe.normal = {}
recipe.normal.enabled = false
recipe.normal.energy_required = 350
recipe.normal.ingredients = {
...
local recipe = {}
recipe.type = "recipe"
recipe.name = "apm_fuel_rod_mox_recovery_stage_a"
...
local recipe = {}
recipe.type = "recipe"
recipe.name = "apm_fuel_rod_mox_recovery_stage_b"
recipe.category = 'chemistry'
recipe.group = "apm_nuclear"
