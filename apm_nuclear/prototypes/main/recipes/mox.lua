...
local recipe = {
	...
	results = {
		...
		{ type = "item",  name = "apm_oxide_pellet_np237",     amount_min = 1,                                             amount_max = 1,                        independent_probability = apm.nuclear.constants.probability_neptunium * 2, show_details_in_recipe_tooltip = false },
