...
if mods.bobpower and apm_nuclear_compat_bob then
	apm.lib.utils.item.overwrite.group('bob-heat-exchanger-2', 'apm_nuclear_machines_1', 'ac_b')
	apm.lib.utils.item.overwrite.group('bob-heat-exchanger-3', 'apm_nuclear_machines_1', 'ac_c')
	apm.lib.utils.item.overwrite.group('bob-steam-turbine-2', 'apm_nuclear_machines_1', 'ad_b')
	apm.lib.utils.item.overwrite.group('bob-steam-turbine-3', 'apm_nuclear_machines_1', 'ad_c')

	apm.lib.utils.item.mod.fuel_category('bob-deuterium-fuel-cell', 'apm_nuclear_deuterium')
	apm.lib.utils.item.mod.fuel_category('bob-deuterium-fuel-cell-2', 'apm_nuclear_deuterium')
end
