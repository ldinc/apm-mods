...
if mods["space-exploration"] and apm_nuclear_compat_earendel then
	apm.lib.utils.recipe.ingredient.replace("se-rtg-equipment", "uranium-fuel-cell",
		"apm_rtg_radioisotope_thermoelectric_generator")
	apm.lib.utils.recipe.ingredient.mod("se-rtg-equipment", "apm_rtg_radioisotope_thermoelectric_generator", 5)
...
if mods.bobplates and apm_nuclear_compat_bob then
	apm.lib.utils.recipe.ingredient.mod("apm_fuel_rod_container", "bob-glass", 5)
	apm.lib.utils.recipe.ingredient.replace("apm_waste_container", "iron-plate", "bob-lead-plate")
	apm.lib.utils.recipe.ingredient.mod("apm_fuel_rod_container", "bob-lead-plate", 5)
	apm.lib.utils.recipe.ingredient.mod("satellite", "bob-silver-zinc-battery", 0)
...
if mods.bobplates and not mods.angelspetrochem and apm_nuclear_compat_bob then
	apm.lib.utils.recipe.ingredient.replace("apm_bromine", "steam", "bob-chlorine")
end
...
if mods.bobwarfare and apm_nuclear_compat_bob then
	...
	apm.lib.utils.recipe.ingredient.mod("bob-uranium-bullet-projectile", "apm_depleted_uranium_ingots", 1)
	apm.lib.utils.recipe.ingredient.replace("bob-shotgun-uranium-shell", "uranium-238", "apm_depleted_uranium_ingots")
	apm.lib.utils.recipe.ingredient.mod("bob-shotgun-uranium-shell", "apm_depleted_uranium_ingots", 5)
end
