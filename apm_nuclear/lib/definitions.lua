...
apm.nuclear.icons.path.bromine_trifluoride = '__apm_resource_pack_ldinc__/graphics/icons/dynamics/apm_bromine_trifluoride.png'
...
apm.nuclear.icons.path.uranium_hexafluoride = '__apm_resource_pack_ldinc__/graphics/icons/dynamics/apm_uranium_hexafluoride.png'
...
apm.nuclear.icons.path.breeder_container_worn = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_worn.png'
apm.nuclear.icons.path.breeder_container_thorium = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_thorium.png'
apm.nuclear.icons.path.breeder_container_thorium_loaded = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_thorium_loaded.png'
apm.nuclear.icons.path.breeder_container_thorium_active = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_thorium_active.png'
apm.nuclear.icons.path.breeder_container_thorium_cooled = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_thorium_cooled.png'
apm.nuclear.icons.path.breeder_container_thorium_seperated = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_thorium_seperated.png'
apm.nuclear.icons.path.breeder_container_uranium = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_uranium.png'
apm.nuclear.icons.path.breeder_container_uranium_loaded = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_uranium_loaded.png'
apm.nuclear.icons.path.breeder_container_uranium_active = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_uranium_active.png'
apm.nuclear.icons.path.breeder_container_uranium_cooled = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_uranium_cooled.png'
apm.nuclear.icons.path.breeder_container_uranium_seperated = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_container_uranium_seperated.png'
apm.nuclear.icons.path.fuel_container = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_container.png'
apm.nuclear.icons.path.fuel_container_worn = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_container_worn.png'
apm.nuclear.icons.path.fuel_container_neptunium = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_neptunium.png'
apm.nuclear.icons.path.fuel_container_neptunium_active = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_neptunium_active.png'
apm.nuclear.icons.path.fuel_container_neptunium_cooled = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_neptunium_cooled.png'
apm.nuclear.icons.path.fuel_container_thorium = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_thorium.png'
apm.nuclear.icons.path.fuel_container_thorium_active = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_thorium_active.png'
apm.nuclear.icons.path.fuel_container_thorium_cooled = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_thorium_cooled.png'
apm.nuclear.icons.path.fuel_container_uranium = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_uranium.png'
apm.nuclear.icons.path.fuel_container_uranium_active = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_uranium_active.png'
apm.nuclear.icons.path.fuel_container_uranium_cooled = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_uranium_cooled.png'
apm.nuclear.icons.path.fuel_container_mox = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_mox.png'
apm.nuclear.icons.path.fuel_container_mox_active = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_mox_active.png'
apm.nuclear.icons.path.fuel_container_mox_cooled = '__apm_resource_pack_ldinc__/graphics/icons/apm_nuclear_fuel_mox_cooled.png'
...
apm.nuclear.icons.path.phosphoroxychlorid  = '__apm_resource_pack_ldinc__/graphics/icons/dynamics/apm_phosphoroxychlorid.png'
apm.nuclear.icons.path.trimethyl_phosphate = '__apm_resource_pack_ldinc__/graphics/icons/dynamics/apm_trimethyl_phosphate.png'
apm.nuclear.icons.path.breeder_uranium_unloading = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_uranium_unloading.png'
apm.nuclear.icons.path.breeder_thorium_unloading = '__apm_resource_pack_ldinc__/graphics/icons/apm_breeder_thorium_unloading.png'
