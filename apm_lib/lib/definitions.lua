...
--
-- ----------------------------------------------------------------------------
apm.lib.icons.path.dummy = '__apm_lib__/graphics/icons/apm_dummy.png'
...
apm.lib.icons.path.signal_burnt_result = '__apm_lib__/graphics/icons/signals/burnt_result.png'
apm.lib.icons.path.signal_radioactive = '__apm_lib__/graphics/icons/signals/radioactive.png'
apm.lib.icons.path.signal_info = '__apm_lib__/graphics/icons/signals/info.png'
apm.lib.icons.path.signal_warning = '__apm_lib__/graphics/icons/signals/warning.png'
apm.lib.icons.path.signal_bullet_point = '__apm_lib__/graphics/icons/signals/bullet_point.png'
...
apm.lib.icons.path.equipment_manager_enabled = '__apm_lib__/graphics/icons/equipment_manager_enabled.png'
apm.lib.icons.path.equipment_manager_enabled_small = '__apm_lib__/graphics/icons/equipment_manager_enabled_small.png'
apm.lib.icons.path.equipment_manager_disabled = '__apm_lib__/graphics/icons/equipment_manager_disabled.png'
apm.lib.icons.path.equipment_manager_disabled_small = '__apm_lib__/graphics/icons/equipment_manager_disabled_small.png'
-- Icons ----------------------------------------------------------------------
--
--
-- ----------------------------------------------------------------------------
