...
-- Thx to https://mods.factorio.com/user/FI for investigation aai compability

if not apm.lib.utils.patch.aai then
    apm.lib.utils.patch.aai = {}
end
        ...
        for _, item in pairs(data.raw.item) do
            if item.fuel_value and item.name ~= 'processed-fuel' and item.fuel_category == 'apm_refined_chemical' then
                ...
                if fuel_value > 0 then
                    ...
                    while (recipe_in * fuel_value >= recipe_out * vehicle_fuel_value * 0.95 or
                        recipe_in * fuel_value < recipe_out * vehicle_fuel_value * 0.90) and
                        recipe_in < 10000 and
                        recipe_out < 1000 do
                    ...
                    local recipe = {
                        ...
                        results = {{'processed-fuel', recipe_out}},
                        localised_name = {
                            'processed-fuel-recipe',
