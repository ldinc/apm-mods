...
function apm.lib.utils.item.add.radioactive_description(item_name, level)
    ...
    APM_LOG_INFO(self, 'add.radioactive_description()',
        'add radioactive description to item: "' .. tostring(item_name) .. '" with level: "' .. tostring(level) .. '"')
end
...
function apm.lib.utils.item.mod.stack_size(item_name, value, b_overwrite)
    ...
    if item.stack_size >= value and not b_overwrite then
        APM_LOG_WARN(self, 'mod.stack_size()',
            'stack_size for item: "' ..
            tostring(item_name) .. '" is higer then "' .. tostring(value) .. '" and b_overwrite is not set, no changes')
        return
    end
...
function apm.lib.utils.item.mod.remove_fuel_value(item_name)
    ...
    APM_LOG_INFO(self, 'remove_fuel_value()',
...
function apm.lib.utils.item.mod.fuel_category(item_name, fuel_category)
    ...
    APM_LOG_INFO(self, 'mod.fuel_category()',
        'item/fluid with name: "' .. tostring(item_name) .. '" set fuel category to "' .. tostring(fuel_category) .. '"')
end
