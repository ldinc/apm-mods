...
apm.lib.utils.data.tables.fluid_container["barrel"].c_side_mask =
"__base__/graphics/icons/fluid/barreling/barrel-side-mask.png"
apm.lib.utils.data.tables.fluid_container["barrel"].c_hoop_top_mask =
"__base__/graphics/icons/fluid/barreling/barrel-hoop-top-mask.png"
apm.lib.utils.data.tables.fluid_container["barrel"].c_empty_side_mask =
"__base__/graphics/icons/fluid/barreling/barrel-empty-side-mask.png"
apm.lib.utils.data.tables.fluid_container["barrel"].c_empty_top_mask =
"__base__/graphics/icons/fluid/barreling/barrel-empty-top-mask.png"
apm.lib.utils.data.tables.fluid_container["barrel"].c_fill_side_mask =
"__base__/graphics/icons/fluid/barreling/barrel-fill-side-mask.png"
apm.lib.utils.data.tables.fluid_container["barrel"].c_fill_top_mask =
"__base__/graphics/icons/fluid/barreling/barrel-fill-top-mask.png"
apm.lib.utils.data.tables.fluid_container["barrel"].c_fill_icon =
"__base__/graphics/icons/fluid/barreling/barrel-fill.png"
apm.lib.utils.data.tables.fluid_container["barrel"].c_empty_icon =
"__base__/graphics/icons/fluid/barreling/barrel-empty.png"
...
--
-- ----------------------------------------------------------------------------
function apm.lib.utils.barrel.new(c_name, empty_c_name, c_side_mask, c_hoop_top_mask, c_empty_side_mask, c_empty_top_mask,
																	c_fill_side_mask, c_fill_top_mask, c_fill_icon, c_empty_icon)
...
function apm.lib.utils.barrel.generate(fluid_name, c_name, technology_name, b_force)
	...
	recipe_fill_barrel.categories = { "crafting-with-fluid" }
	...
	recipe_empty_filled_barrel.categories = { "crafting-with-fluid" }
	...
	APM_LOG_INFO(self, "generate()",
		'Recipes for filling and emptying barrels generated for "' .. tostring(fluid.name) .. '"')
end
