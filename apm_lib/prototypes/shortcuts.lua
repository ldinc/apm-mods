...
apm_equipment_manager.icon = apm.lib.icons.path.equipment_manager_enabled
apm_equipment_manager.icon_size = 32

apm_equipment_manager.small_icon = apm.lib.icons.path.equipment_manager_enabled_small
apm_equipment_manager.small_icon_size = 24
